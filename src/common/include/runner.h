...
// Module enumeration
typedef enum {
    MOD_INIT = 0,                   // the initial module to load, runs all module initialisation
    MOD_LEGACY_HOSTS_DEVICES,       // legacy module for hosts and devices on same screen
    ...
    MOD_WIFI,                       // view/pick wifi, legacy module
